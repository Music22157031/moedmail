...
// Host the bot:
require('http')
  .createServer((req, res) => res.end('Now go to ANY uptimer app and paste ⬆ link.'))
  .listen(3030);



console.log(`ModMail by SpicyDevs`);
          ...
          new EmbedBuilder()
            ...
            .addFields(
              ...
              },
              {
                ...
                value: "Unfortunately, you are not allowed to reshare this code from Aayu5h1737 Please DM him and ask the permission to share, else you will get a copyright warning from him. Thanks :)"
              }
            )
            .setColor('Blue')
            .setFooter(
              {
                text: "Developed by: Aayu5h#1737"
              }
            )
        ],
        ephemeral: true
